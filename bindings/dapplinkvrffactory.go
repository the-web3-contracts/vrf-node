...
var DappLinkVRFFactoryMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"function\",\"name\":\"createProxy\",\"inputs\":[{\"name\":\"implementation\",\"type\":\"address\",\"internalType\":\"address\"},{\"name\":\"dapplinkAddress\",\"type\":\"address\",\"internalType\":\"address\"},{\"name\":\"blsRegistry\",\"type\":\"address\",\"internalType\":\"address\"}],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"address\"}],\"stateMutability\":\"nonpayable\"},{\"type\":\"event\",\"name\":\"ProxyCreated\",\"inputs\":[{\"name\":\"mintProxyAddress\",\"type\":\"address\",\"indexed\":false,\"internalType\":\"address\"}],\"anonymous\":false},{\"type\":\"error\",\"name\":\"FailedDeployment\",\"inputs\":[]},{\"type\":\"error\",\"name\":\"InsufficientBalance\",\"inputs\":[{\"name\":\"balance\",\"type\":\"uint256\",\"internalType\":\"uint256\"},{\"name\":\"needed\",\"type\":\"uint256\",\"internalType\":\"uint256\"}]}]",
	Bin: "",
}
...
//
// Solidity: function createProxy(address implementation, address dapplinkAddress, address blsRegistry) returns(address)
func (_DappLinkVRFFactory *DappLinkVRFFactoryTransactor) CreateProxy(opts *bind.TransactOpts, implementation common.Address, dapplinkAddress common.Address, blsRegistry common.Address) (*types.Transaction, error) {
	return _DappLinkVRFFactory.contract.Transact(opts, "createProxy", implementation, dapplinkAddress, blsRegistry)
}

// CreateProxy is a paid mutator transaction binding the contract method 0xa556c07e.
//
// Solidity: function createProxy(address implementation, address dapplinkAddress, address blsRegistry) returns(address)
func (_DappLinkVRFFactory *DappLinkVRFFactorySession) CreateProxy(implementation common.Address, dapplinkAddress common.Address, blsRegistry common.Address) (*types.Transaction, error) {
	return _DappLinkVRFFactory.Contract.CreateProxy(&_DappLinkVRFFactory.TransactOpts, implementation, dapplinkAddress, blsRegistry)
}

// CreateProxy is a paid mutator transaction binding the contract method 0xa556c07e.
//
// Solidity: function createProxy(address implementation, address dapplinkAddress, address blsRegistry) returns(address)
func (_DappLinkVRFFactory *DappLinkVRFFactoryTransactorSession) CreateProxy(implementation common.Address, dapplinkAddress common.Address, blsRegistry common.Address) (*types.Transaction, error) {
	return _DappLinkVRFFactory.Contract.CreateProxy(&_DappLinkVRFFactory.TransactOpts, implementation, dapplinkAddress, blsRegistry)
}
